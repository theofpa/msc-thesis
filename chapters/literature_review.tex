...
The information service in version 3.1 of gLite is similar to \ac{MDS} of Globus middleware, except that the \ac{GRIS} and \ac{GIIS} are provided by \ac{BDII} (see Section \nameref{subsec:BDII}) which is an LDAP based service.
