...
\begin{figure}[htb]
\centering
 \includegraphics[width=5in]{images/is.eps}
...
\begin{verbatim}
# yum install rrdtool perl-rrdtool rrdtool-devel apr-devel libconfuse \
              libconfuse-devel expat expat-devel pcre pcre-devel
